...
//		public static float idleSpeed = 0f;
        ...
        private void Awake()
        {
			...
			firecracker = transform.FindChild ("firecracker");
			if (firecracker == null) {
				Debug.LogError ("no firecracker obj as a child of player");
			}
        }
...
//        }
        ...
        private void Flip()
        {
            ...
            Vector3 theScale = firecracker.localScale;
            theScale.x *= -1;
			firecracker.localScale = theScale;
        }
    }
}
